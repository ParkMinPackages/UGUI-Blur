...
### Fixed
- Mapped Image-mode blur sampling through the Source Image's RectTransform, preserve-aspect drawing rect, and Sprite Atlas UV region so moving or resizing the Source updates the displayed blur coordinates.
